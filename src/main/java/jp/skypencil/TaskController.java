...
/**
 * The Controller handling feature regarding tasks.
 * Just translate rest-controller related values to help domain objects understand requests from user.
 */
@RestController
public class TaskController {
    ...
    public TaskModel find(@PathVariable("id") UUID id) {
        return service.find(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "No task found with id: " + id));
    }
